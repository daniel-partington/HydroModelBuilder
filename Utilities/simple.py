...
def rect_interpolate(interp_point, known_points):
    ...
    a1 = known_points[0][2]+(interp_point[0]-known_points[0][0])*(known_points[1][2]-known_points[0][2])/(known_points[1][0]-known_points[0][0])
    a2 = known_points[2][2]+(interp_point[0]-known_points[2][0])*(known_points[3][2]-known_points[2][2])/(known_points[3][0]-known_points[2][0])    
