...
def build_vtk_from_array(grid_info, mesh_z, point_array_names, point_arrays, cell_array_names, cell_arrays, out_path, vtk_out):
    ...
    #mesh_pad = np.transpose(mesh, (2,1,0))
